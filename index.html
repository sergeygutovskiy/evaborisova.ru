...
<head>
	...
	<!-- animate -->
	<script scr="js/anime-master/lib/animate.min.js"></script>
...
<body>
	...
	<nav class="nav-mobile">
		...
		<ul class="nav__links">
			<li class="nav__link"><a href="#">Галерея</a></li>
			<li class="nav__link"><a href="#">Услуги</a></li>
			<li class="nav__link"><a href="#">Проекты</a></li>
	...
	<main>
		<section class="backgrounds">
			...
			<section class="backgrounds__item backgrounds__item-gallery gallery">
				...
				<div class="gallery__images">	
					...
					<div class="gallery__title">
						<h2>Ремонт <br> ремонтный</h2>
						<a href="#" class="golden-rain">Перейти на страницу проекта</a>
					</div>
			...
			<section class="backgrounds__item backgrounds__item-services">
				<div class="backgrounds__back-color"></div>
				3
			</section>
